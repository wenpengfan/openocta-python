          ...
          state.tab === "digitalEmployee"
            ? renderDigitalEmployee({
                ...
                onEdit: async (employeeId) => {
                  ...
                  state.digitalEmployeeEditSkillsToDelete = [];
                  state.digitalEmployeeEditEnabled = manifest.enabled !== false;
                  state.digitalEmployeeEditWeWorkGroupBotKey = (manifest as any).weworkGroupBotKey ?? "";
                  state.digitalEmployeeEditError = null;
                },
                ...
                editWeWorkGroupBotKey: state.digitalEmployeeEditWeWorkGroupBotKey,
                ...
                onEditWeWorkGroupBotKeyChange: (v) => {
                  state.digitalEmployeeEditWeWorkGroupBotKey = v;
                },
