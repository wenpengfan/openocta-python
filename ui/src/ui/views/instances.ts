  ...
  return html`
    <section class="card">
      <div class="row" style="justify-content: space-between;">
        <div>
          <div class="card-title">${t("instancesTitle")}</div>
          <div class="card-sub">${t("instancesSub")}</div>
        </div>
      ...
      <div class="list" style="margin-top: 16px;">
        ${
          props.entries.length === 0
            ? html`
                <div class="muted">${t("instancesNoReported")}</div>
              `
...
function renderEntry(entry: PresenceEntry) {
  ...
  return html`
    <div class="list-item">
      <div class="list-main">
        <div class="list-title">${entry.host ?? t("instancesUnknownHost")}</div>
      ...
      <div class="list-meta">
        ...
        <div class="muted">${t("instancesLastInput")} ${lastInput}</div>
        <div class="muted">${t("instancesReason")} ${entry.reason ?? ""}</div>
      </div>
    </div>
  `;
}
