  ...
  return html`
    <div class="nostr-profile-form" style="padding: 16px; background: var(--bg-secondary); border-radius: 8px; margin-top: 12px;">
      <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 16px;">
        <div style="font-weight: 600; font-size: 16px;">${t("nostrEditProfile")}</div>
        <div style="font-size: 12px; color: var(--text-muted);">${t("nostrAccount")}: ${accountId}</div>
      </div>
      ...
      ${renderField("name", t("nostrUsername"), {
        placeholder: "satoshi",
        maxLength: 256,
        help: "Short username (e.g., satoshi)",
      })}

      ${renderField("displayName", t("nostrDisplayName"), {
        placeholder: "Satoshi Nakamoto",
        maxLength: 256,
        help: "Your full display name",
      })}

      ${renderField("about", t("nostrBio"), {
        type: "textarea",
      ...
      ${renderField("picture", t("nostrAvatarUrl"), {
        type: "url",
        ...
        state.showAdvanced
          ? html`
            <div style="border-top: 1px solid var(--border-color); padding-top: 12px; margin-top: 12px;">
              <div style="font-weight: 500; margin-bottom: 12px; color: var(--text-muted);">${t("nostrAdvanced")}</div>

              ${renderField("banner", t("nostrBannerUrl"), {
                type: "url",
                placeholder: "https://example.com/banner.jpg",
                help: "HTTPS URL to a banner image",
              })}

              ${renderField("website", t("nostrWebsite"), {
                type: "url",
                placeholder: "https://example.com",
                help: "Your personal website",
              })}

              ${renderField("nip05", t("nostrNip05"), {
                placeholder: "you@example.com",
                help: "Verifiable identifier (e.g., you@domain.com)",
              })}

              ${renderField("lud16", t("nostrLud16"), {
      ...
      <div style="display: flex; gap: 8px; margin-top: 16px; flex-wrap: wrap;">
        ...
        >
          ${state.saving ? t("commonSaving") : t("nostrSavePublish")}
        </button>
        ...
        >
          ${state.importing ? t("nostrImporting") : t("nostrImportRelays")}
        </button>
        ...
        >
          ${state.showAdvanced ? t("nostrHideAdvanced") : t("nostrShowAdvanced")}
        </button>
